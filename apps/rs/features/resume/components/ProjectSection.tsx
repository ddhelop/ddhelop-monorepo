        ...
        <div className="space-y-12">
          {projectsData.items.map((project, index) => (
            <div key={project.id} className="relative">
              ...
              {/* Mobile View - Top Row (Logo & Name) */}
              <div className="flex flex-row items-center gap-4 md:hidden mb-4">
                {project.logo ? (
                  <div className="relative w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-md overflow-hidden">
                    <Image
                      src={project.logo}
                      alt={`${project.name} 로고`}
                  ...
                  <div className="w-12 h-12 flex-shrink-0 bg-blue-600 text-white flex items-center justify-center rounded-md">
              ...
              <div className="flex flex-col md:flex-row md:gap-8">
                ...
                <div className="hidden md:block md:w-1/4 md:sticky md:top-24 md:self-start space-y-4">
                  {/* Logo */}
                  {project.logo ? (
                    ...
                    <div className="flex flex-row space-x-3 md:hidden">
                      {project.links.github && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-sm text-blue-600 hover:underline underline flex items-center gap-1"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                      ...
                      {project.links?.websites &&
                        ...
                        project.links.websites.map((website, idx) => (
                          <a
                            key={`${project.id}-mobile-website-${idx}`}
                            href={website.url}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-sm text-blue-600 hover:underline underline flex items-center gap-1"
