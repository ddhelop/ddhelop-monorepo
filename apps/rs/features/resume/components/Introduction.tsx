...
export const introductionText = [
  ...
  '지난 1년간 <link href="https://">5,000개 이상의 커밋을 기록하며</link>, 다양한 프로젝트를 경험했고, 특히 Next.js와 TypeScript 기반의 반응형 웹 서비스 개발에 익숙합니다. 디자인과 실제 구현 사이의 미세한 차이까지 조율할 수 있는 <sb>섬세한 감각을 갖추었으며,</sb> 성능·접근성·유지보수를 고려한 <sb>구조 설계와 reflow 최적화에도 꾸준히 집중</sb>해왔습니다.',
