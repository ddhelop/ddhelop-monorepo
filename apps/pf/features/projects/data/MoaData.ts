...
const projectData: ProjectItemData = {
  ...
  introduction: {
    description: [
      '모아 커뮤니티는 각 지역 주민들이 자유롭게 소통하고 정보를 나눌 수 있도록 기획된 <sb>하이퍼로컬 커뮤니티 플랫폼</sb>입니다.',
      '에브리타임처럼 익명 기반 게시판 구조를 중심으로, 동네 인증/게시판 요청 등의 구조를 설계했으며, 반응형 UI와 직관적인 UX에 중점을 두었습니다.',
      '본 프로젝트는 <sb>바이브 코딩 기반</sb>으로 기획과 실험을 빠르게 반복하며, <sb>실제 서비스 구조를 직접 구상하고 빠르게 구현하는 데 집중</sb>한 프로젝트입니다.',
  ...
  summary: [
    {
      id: 'summary-1',
      text: 'Figma 없이 <sb>Cursor AI와 직접 소통하며 UI 구조와 레이아웃을 코드로 바로 설계 및 구현</sb>했습니다.',
    },
  ],
